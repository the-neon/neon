...
describe("Email Validator", () => {
  ...
  let undefinedEmail: string | undefined;
...
describe("`Not Empty` Validator", () => {
  ...
  const emptyString = "";
  let nullString: string | undefined;
  ...
  let nullNumber: number | undefined;
  ...
  let nullBool: boolean | undefined;
  ...
  const emptyArray = [];
  let nullArray: unknown[] | undefined;
  ...
  const validObj = { id: 1 };
  const emptyObj = {};
  let nullObj: { id: unknown } | undefined;
